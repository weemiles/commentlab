...
// Retain the transcript for per-batch retrieval, including middle passages.
// Bound exceptional inputs and disclose any source truncation.
export function transcriptContext(text, details = {}) {
  ...
  return {
    ...
    text: partial ? clean.slice(0, MAX_TEXT) : clean
  };
}
