...
export async function analyzeVideo(body, { maxAllowed = DEFAULT_MAX_COMMENTS, report = () => {}, allowPublicFallback = true, collectorUrl = '', apiKey } = {}) {
  ...
  const cacheId = privateCache.key(apiKey, [extractVideoId(body.url), body.demo === true, analysisLanguage, maxComments, collectorUrl, allowPublicFallback, SENTIMENT_VERSION, 'opinions-v4', process.env.TYPESAFE_MODEL || 'jev-preview']);
