...
export async function fetchFastVideoAndComments({ videoId, maxComments = 3000, sortBy = "new", fetchImpl = fetch, collectorUrl = "", requestDelayMs = Number(process.env.YOUTUBE_REQUEST_DELAY_MS ?? 0), concurrency = Number(process.env.YOUTUBE_FETCH_CONCURRENCY ?? 16), onProgress = () => {} }) {
