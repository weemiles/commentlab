...
- `lib/access.js`: analysis requires a visitor key and must never use owner credentials; the separate collector requires its site token. Never load another project's keys or use the maintainer's API.
